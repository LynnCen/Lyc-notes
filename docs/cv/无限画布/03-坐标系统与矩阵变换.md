...
1. [为什么需要理解坐标系统](#一为什么需要理解坐标系统)
2. [三个坐标系的深度解析](#二三个坐标系的深度解析)
3. [坐标转换的数学本质](#三坐标转换的数学本质)
4. [2D仿射变换矩阵](#四2d仿射变换矩阵)
5. [矩阵运算的代码实现](#五矩阵运算的代码实现)
6. [复合变换与实际应用](#六复合变换与实际应用)
7. [矩阵分解原理](#七矩阵分解原理)
8. [包围盒与碰撞检测](#八包围盒与碰撞检测)
9. [向量运算与角度计算](#九向量运算与角度计算)
10. [实战案例分析](#十实战案例分析)
...
> **下一章**：[第4章：Surface 画布表面层](./04-Surface画布表面层.md) —— 理解渲染架构的顶层设计
