...
![alt text](./img/Performance记录添加元素的执行过程.png)
...
![alt text](./img/触发强制同步布局Performance图.png)
...
![alt text](./img/Performance中关于布局抖动的表现.png)
